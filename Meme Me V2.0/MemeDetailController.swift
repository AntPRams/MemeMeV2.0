...
class MemeDetailController: MemeMeController {
    ...
    @IBAction func editButton(_ sender: Any) {
        ...
        guard let controller = self.storyboard?.instantiateViewController(withIdentifier: "EditMemeController") as? EditMemeController else {return}
...
extension MemeDetailController: UITextFieldDelegate {
    ...
    func initTextField(_ textField : UITextField, text : String, attribute : [NSAttributedString.Key : Any], userIteraction: Bool) {
    ...
    func setupTextField(font: String) {
        ...
        initTextField(topTextField, text: "", attribute: attributes, userIteraction: false)
        initTextField(bottomTextField, text: "", attribute: attributes, userIteraction: false)
